...
<script>
    $(function () {
       ...
       $("#motifyActicleForm").form('load',
           '${pageContext.request.contextPath}/article/findById?id=${param.id}');
    });
</script>

<div style="text-align: center">
    <form method="post" class="easyui-form" id="motifyActicleForm" enctype="multipart/form-data">
        <input name="id" type="hidden">

        <div style="margin-top: 50px">
            <label style="margin-right: 52px">大师:</label>
            <select id="cc" name="guru_id" style="width: 195px;height: 25px;">
                <option value=""></option>
            </select>
        </div>
